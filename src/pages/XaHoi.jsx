    ...
    <>
      ...
      >
        <div className="text-[6rem] text-primary font-[700]">
          Tha hóa trong xã hội
        </div>
        <div className="flex items-center justify-center mt-[20px] mr-[100px]">
          <Link
            to={"/"}
      ...
      <section className="py-[110px] w-[1140px] flex mx-auto gap-[40px]">
        <div className="w-[64%]">
          ...
          <p className="text-[2rem] text-[#746e5e] mb-[28px]">
            Tha hoá xã hội là hệ quả mở rộng của tha hoá trong lao động, phản
            ánh mâu thuẫn giai cấp và sự phân hóa giàu nghèo trong xã hội tư
            bản.
          </p>
          <ul>
              ...
              <span className="text-[2rem] text-[#746e5e]">
                ...
                <ul className="ml-[50px]">
                  <li className="my-[10px]">
                    ...
                    />
                    Xã hội bị chia thành hai giai cấp đối lập:giai cấp tư sản
                    (sở hữu tư liệu sản xuất) và giai cấp công nhân (chỉ có sức
                    lao động).
                  </li>
                  <li className="my-[10px]">
                    <CircleIcon
                    ...
                    />
                    Quan hệ giữa họ là quan hệ bóc lột – bị bóc lột, biểu hiện
                    tập trung của tha hoá xã hội.
                  </li>
                </ul>
              </span>
            </li>
              ...
              <span className="text-[2rem] text-[#746e5e]">
                ...
                <ul className="ml-[50px]">
                  <li className="my-[10px]">
                    ...
                    />
                    Tích lũy tư bản dẫn đến sự giàu có cực độ của giai cấp tư
                    sản và nghèo khổ tương đối của người lao động.
                  </li>
                  <li className="my-[10px]">
                    <CircleIcon
                      className="mr-[10px] text-[#9694ae] mb-[5px]"
                    ...
                    />
                    Quá trình này làm gia tăng bất bình đẳng, xói mòn tính nhân
                    văn, và làm sâu sắc mâu thuẫn giai cấp.
                  </li>
                </ul>
              </span>
            </li>
              ...
              <span className="text-[2rem] text-[#746e5e]">
                ...
                <ul className="ml-[50px]">
                  <li className="my-[10px]">
                    ...
                    />
                    Nền kinh tế thị trường vận hành vì lợi nhuận tối đa, khiến
                    các giá trị đạo đức bị thương mại hóa.
                  </li>
                  <li className="my-[10px]">
                    <CircleIcon
                      className="mr-[10px] text-[#9694ae] mb-[5px]"
                    ...
                    />
                    Con người bị cuốn vào vòng xoáy vật chất – cạnh tranh – ích
                    kỷ, làm suy yếu các mối quan hệ xã hội nhân văn.
                  </li>
                </ul>
              </span>
            </li>
          ...
          <div className="mt-[50px] flex items-center justify-between">
            <div className="text-primary text-[2.1rem]">
              <span className="text-[#746e5e]">Từ khóa: </span>Tha hóa xã hội
            </div>
        ...
        <div className="flex-1">
          ...
          >
            ...
            <div>
              ...
              <h3 className="text-primary text-[2.2rem] 2xl:text-[2rem] hover:text-[#d0bc80] transition-colors duration-300 my-[10px]">
                <Link to={"/tha-hoa-lao-dong"}>Tha hóa trong lao động</Link>
              </h3>
              <p className="text-[#d0bc80] text-[1.3rem] font-[700] uppercase">
                Group 1 & 5 | 05/10/2025
              </p>
